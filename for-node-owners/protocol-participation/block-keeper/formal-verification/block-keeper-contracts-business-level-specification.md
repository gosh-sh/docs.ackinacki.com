...
In order to submit stakes at least one _License_ must be delegated to _BK Wallet_. Up to _20_ _Licenses_ can be delegated. A _License_ can be delegated just to one _BK wallet_.
